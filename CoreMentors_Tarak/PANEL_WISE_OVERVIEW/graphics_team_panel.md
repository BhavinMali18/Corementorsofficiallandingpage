# Graphics Team Panel - Complete Overview
...
**Panel Name:** Graphics Team Panel  
...
│   Role Binding: Graphics Team only │
└─────────────────────────────────────┘
```
...
**Purpose:** Profile completion system for Graphics Team member.

**Scope:** Graphics Team member has access to My Profile module.
...
**Special Rules for Graphics Team:**
...
**Scope:** Graphics Team member has access to Work Time module.
...
- Graphics Team → verified by **Reporting Authority (Manager)**
...
**Purpose:** View work items in GFX department pool.

**Scope:** Graphics Team member can view all work items in GFX department pool.

**Key Features:**
- View all work items in GFX department pool
- Cannot create work (GFX cannot create work)
...
- Can view all work items in GFX department
- Cannot see other department pools (Sales, Accounts, Development)
...
1. **Token Required:** Graphics Team panel requires access token
...
**Status:** Complete Graphics Team panel documentation with My Profile + Document Wallet (Instruction 4), Work Time (Instruction 5), Work Time Requests + My Activity (Instruction 7), and Work Hub Department Pool View (Instruction 10)
