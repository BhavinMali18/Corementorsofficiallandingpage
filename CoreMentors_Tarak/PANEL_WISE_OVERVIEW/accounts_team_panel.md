# Accounts Team Panel - Complete Overview
...
**Panel Name:** Accounts Team Panel  
...
│   Role Binding: Accounts Team only │
└─────────────────────────────────────┘
```
...
**Purpose:** Profile completion system for Accounts Team member.

**Scope:** Accounts Team member has access to My Profile module.
...
**Special Rules for Accounts Team:**
...
**Scope:** Accounts Team member has access to Work Time module.
...
- Accounts Team → verified by **Reporting Authority (Manager)**
...
**Purpose:** View work items in Accounts department pool.

**Scope:** Accounts Team member can view all work items in Accounts department pool.

**Key Features:**
- View all work items in Accounts department pool
- Cannot create work (Accounts cannot create work)
...
- Can view all work items in Accounts department
- Cannot see other department pools (Sales, Development, GFX)
...
1. **Token Required:** Accounts Team panel requires access token
...
**Status:** Complete Accounts Team panel documentation with My Profile + Document Wallet (Instruction 4), Work Time (Instruction 5), Work Time Requests + My Activity (Instruction 7), and Work Hub Department Pool View (Instruction 10)
